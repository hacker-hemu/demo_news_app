...
import 'package:demo_news_app/models/tv_models/recommended_channels.dart';
...
class TvRecommendedChannelsScreen extends StatefulWidget {
  const TvRecommendedChannelsScreen({Key? key, this.recommendedChannels})
      : super(key: key);
  final RecommendedChannels? recommendedChannels;

  @override
  State<TvRecommendedChannelsScreen> createState() =>
      _TvRecommendedChannelsScreenState();
}

class _TvRecommendedChannelsScreenState
    extends State<TvRecommendedChannelsScreen> {
  // save ads
  ...
  Widget build(BuildContext context) {
    ...
    RecommendedChannels? channel = widget.recommendedChannels;
    return SafeArea(
      child: Scaffold(
  ...
  void initState() {
    ...
    url = YoutubePlayer.convertUrlToId(
        '${widget.recommendedChannels?.videoLink}');
